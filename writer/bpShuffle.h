 ...
 ***************************************************************************/
#ifndef __BP_SHUFFLE__
#define __BP_SHUFFLE__


#include "bpCompressionAlgorithm.h"


class bpShuffle : public bpCompressionAlgorithm
{
public:
  bpShuffle(bpSize aNBytes, bpCompressionAlgorithm::tPtr aCompressionAlgorithm);
